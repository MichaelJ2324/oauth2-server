...
class SessionEntity
{
     ...
     * Client identifier
     *
     * @var \OAuth2\Server\Entity\ClientEntity
     */
    protected $client;
     ...
     * Auth code
     *
     * @var \OAuth2\Server\Entity\AuthCodeEntity
     */
    protected $authCode;
     ...
     * Refresh token
     *
     * @var \OAuth2\Server\Entity\RefreshTokenEntity
     */
     ...
     *
     * @var \OAuth2\Server\AuthorizationServer|\OAuth2\Server\ResourceServer
     */
    protected $server;
     ...
     * Associate a scope
     *
     * @param \OAuth2\Server\Entity\ScopeEntity $scope
     *
     * @return self
     */
     ...
     *
     * @param  \OAuth2\Server\Entity\Scope[]
     *
     * @return array
     */
     ...
     *
     * @param \OAuth2\Server\Entity\AccessTokenEntity $accessToken
     *
     * @return self
     */
     ...
     *
     * @param \OAuth2\Server\Entity\RefreshTokenEntity $refreshToken
     *
     * @return self
     */
     ...
     *
     * @param \OAuth2\Server\Entity\ClientEntity $client The client
     *
     * @return self
     */
